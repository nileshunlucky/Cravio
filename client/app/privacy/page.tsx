      ...
      >
        <Card className="border border-muted shadow-md rounded-xl bg-white">
          <CardContent className="px-8 py-10 space-y-6">
            {/* Back Button */}
            <Button variant="outline" onClick={() => window.history.back()} className="text-black hover:bg-gray-200">
              &larr; Back
            </Button>
            ...
            <h2 className="text-xl font-semibold text-black">3. Data Security</h2>
            <p className="text-muted-foreground text-lg">
            ...
            <h2 className="text-xl font-semibold text-black">4. Sharing Your Information</h2>
            <p className="text-muted-foreground text-lg">
            ...
            <h2 className="text-xl font-semibold text-black">5. Your Rights</h2>
            <p className="text-muted-foreground text-lg">
            ...
            <h2 className="text-xl font-semibold text-black">7. Changes to This Privacy Policy</h2>
            <p className="text-muted-foreground text-lg">
