...
const imageCollections = [
  {
    ...
    small: [
      {
        url: "https://higgsfield.ai/_next/image?url=https%3A%2F%2Fdqv0cqkoy5oj7.cloudfront.net%2Fuser_2vVDbuYVi2MJIPsi6xaVxFcvKjD%2F6e437f80-dfd3-4e5c-828f-97175ebfc993.png&w=640&q=75",
      ...
      {
        url: "https://higgsfield.ai/_next/image?url=https%3A%2F%2Fdqv0cqkoy5oj7.cloudfront.net%2Fuser_2vtxM3DRcDcQIjpmiCpUDF2wcAT%2F410ed1aa-c326-43af-8bb9-46f0c34fa153.png&w=640&q=75",
        prompt: "Under a solitary, crisp-edged spotlight casting a cool, silver glow, the model reclines on an expanse of midnight-black volcanic sand, the grains glistening with wetness beneath the focused beam. Her bleached brows and sharp gaze draw the eyes upward, fixed intently on a drone's soft, distant hum hovering just beyond the light's fringe, unseen but profoundly present. The sculpted leather corset molds her form with impeccable precision, the glint of its textured surface contrasting with the sleek, polished metal soles of knee-high boots that catch the spotlight in shards of reflected starlight. A sheer, diaphanous dress whips and presses into the sand like fossilized waves caught under the pressure of an unseen tide, the fabrics delicate translucence highlighted where the spotlight grazes, revealing whisper-thin folds that command attention despite their ghostlike quality. The interplay of darkness and light sculpts the immediate space: rough, granular sand dissolves rapidly into opaque shadow, leaving only the illuminated tableau in sharp focus. Lens set low and intimate, the camera frames her from a close angle, a shallow depth of field sharpening every facet of leather and textile while allowing the edges of shadow to fade into an indistinct abyss. This precise composition captures a moment suspended between earth and technology, tension and stillness. Rendered in a stark, minimal digital profile that accentuates hyper-realism—every pore, thread, and grain is tactile, every highlight deliberate—this is high-fashion editorial, hyper-real texture fidelity."
      },
      {
      ...
      {
        url: "https://higgsfield.ai/_next/image?url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fcontent_user_id%2Fe06dc1af-3e6a-44d1-a117-a78a20e30fe5.jpeg&w=640&q=75",
