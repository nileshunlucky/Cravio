  ...
  return (
    <nav className="w-full  border-b shadow-sm py-2 px-4 flex items-center justify-between">
      ...
      <div className="flex items-center gap-5">
        <a href={`https://cravioai.lemonsqueezy.com/buy/4776476e-309d-4c69-b790-a8bcaab86565?checkout[email]=${encodeURIComponent(email || '')}`}>
        <Button style={{ boxShadow: '0 0 15px rgba(255, 215, 100, 0.5)' }} className='bg-[#B08D57] hover:bg-[#B08D57]/80 font-medium'>
          Exclusive Trial
        </Button></a>
