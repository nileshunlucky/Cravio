    ...
    <nav className="w-full  border-b shadow-sm py-2 px-4 flex items-center justify-between">
     ...
     <Link href="/admin/dashboard"><Image src='/logo.png' alt="Logo"  width={50} height={50}/></Link> 
      ...
      <div className="flex items-center gap-5">
        {/* Offer */}
        {isOfferOpen && <Offer />}
        <Button onClick={handleOffer} className="bg-gradient-to-r from-red-600 to-yellow-500 text-white text-sm px-3 py-1 shadow-md">Exclusive $1 trial</Button>
