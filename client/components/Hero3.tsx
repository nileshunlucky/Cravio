    ...
    <div className="overflow-x-hidden">
      <main className="relative z-10">
        ...
        <section ref={heroRef} className="min-h-[120vh] flex flex-col items-center justify-center text-center px-4">
          ...
          <p ref={subtitleRef} className="md:text-xl md:text-2xl text-zinc-500 max-w-4xl mx-auto font-light tracking-wide mb-12">
        ...
        <section ref={cardsContainerRef} className="h-screen flex items-center justify-center">
          <div className="relative w-[250px] md:w-[400px] h-[200px] md:h-[480px]">
            {/* Left Card */}
            <div
              ref={card1Ref}
              className="absolute w-[320px] h-full bg-white/5 backdrop-blur-xl rounded-3xl  shadow-2xl left-1/2 -translate-x-[130%] top-1/2 -translate-y-1/2"
              style={{
            ...
            <div
              ref={card2Ref}
              className="absolute w-full h-full bg-white/10 backdrop-blur-2xl rounded-3xl shadow-2xl left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-10"
              style={{
            ...
            <div
              ref={card3Ref}
              className="absolute w-[320px] h-full bg-white/5 backdrop-blur-xl rounded-3xl  shadow-2xl left-1/2 translate-x-[30%] top-1/2 -translate-y-1/2"
              style={{
        ...
        <section className="h-screen flex items-center justify-center">
          <div className="text-center">
            <h2 className="text-3xl md:text-7xl font-bold text-zinc-200 mb-4 whitespace-nowrap">The Next Chapter</h2>
            <p className=" md:text-2xl text-zinc-500">Your journey continues here.</p>
          </div>
        </section>
      </main>
    </div>
