  ...
  return (
    <div className="w-full space-y-2">
      ...
      >
        ...
        <SliderPrimitive.Thumb className="block h-4 w-4 rounded-full  focus-visible:ring-2 focus-visible:ring-offset-2" />
        <SliderPrimitive.Thumb className="block h-4 w-4 rounded-full  focus-visible:ring-offset-2" />
      </SliderPrimitive.Root>
    </div>
  )
}
