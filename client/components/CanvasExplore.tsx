...
const imageCollections = [
  {
    image: [
      ...
      {
        url: "https://res.cloudinary.com/deoxpvjjg/image/upload/v1753892500/f1f24c26-fa9f-4493-86c3-61bddc7187ff_dfazz0.png",
      ...
      {
        url: "https://res.cloudinary.com/deoxpvjjg/image/upload/v1753892088/a6cd9f67-75f4-42aa-94ef-a8f64a10e39d_yitoco.png",
      ...
      {
        url: "https://res.cloudinary.com/deoxpvjjg/image/upload/v1753891825/ec421420-ad34-4231-bfbe-c2ae5088a5c7_khziqo.png",
      ...
      {
        url: "https://res.cloudinary.com/deoxpvjjg/image/upload/v1753892328/34cca34c-b788-4b94-801f-d1b510e181cd_d3o3eh.png",
...
export default function PremiumGalleryLayout() {
  return (
    <div id="canvas" className="min-h-screen bg-black">
      <div className="w-full px-2 md:px-4 lg:px-6 py-4 md:py-8">
        <div className="space-y-8 md:space-y-12">
          <div >
            <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-br from-[#B08D57] to-[#4e3c20] bg-clip-text text-transparent mb-4">
              Canvas
            </h1>
            <p className="text-gray-400 text-lg md:text-xl">
              Explore and create with our curated collection of AI-generated images
            </p>
          </div>
